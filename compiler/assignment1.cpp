...
cout<<setw(10)<<"States"<<setw(10)<<"a"<<setw(10)<<"b"<<setw(10)<<"e"
<<setw(10)<<"e"<<endl;
 for(int i=0;i<60;i++)
 cout<<"-";
 cout<<endl;
...
int main()
{
 ...
 int states=0;
 cout<<"**Regular Expression to DFA Convertor**"<<endl;
 cout<<"Enter a regular expression such as (a|b)*abb: ";
 string s;
 cin>>s;
 s=preprocessor(s);
 cout<<"After preprocessing "<<s;
 cout<<endl;
 s=postfix(s);
 cout<<"Postfix "<<s<<endl;
 ...
 // Additional Simulator to check if a string can be passed or not.
 while(true)
 {
 string word;
 cout<<"Enter the string to check whether it belongs to given regular expression or not."<<endl<<"OR press 1 to exit out of simulator."<<endl;
